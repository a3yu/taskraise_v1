...
import OrderDetailsDashboard from "@/components/dashboard/page/OrderDetailsDashboard";

async function OrderDetailsMainDash({ params }: { params: { id: string } }) {
...
export default OrderDetailsMainDash;
